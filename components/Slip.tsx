...
const playerName = (player: RankedPlayer | undefined) => (
  player?.name ?? 'None'
);
...
const Slip: React.FC<SlipProps> = ({ event, match, players }) => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="600px"
      ...
      <text transform="matrix(1 0 0 1 35.5 37.624)" fontFamily="'MyriadPro-Regular'" fontSize="12">{players[0]?.points || 0} - {playerName(players[0])}</text>
      ...
      <text transform="matrix(1 0 0 1 35.5 69.1245)" fontFamily="'MyriadPro-Regular'" fontSize="12">{players[1]?.points || 0} - {playerName(players[1])}</text>
      ...
      <text transform="matrix(1 0 0 1 71 103.2485)" fontFamily="'MyriadPro-Regular'" fontSize="12">{playerName(players[0])}: _______________________</text>
      <text transform="matrix(1 0 0 1 289 103.2485)" fontFamily="'MyriadPro-Regular'" fontSize="12">{playerName(players[1])}: _______________________</text>
